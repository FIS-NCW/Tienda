                                                    ...
                                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                        <div class="products-single fix">
                                                            <div class="box-img-hover">
                                                                <div class="type-lb">
                                                                    <p class="sale">
                                                                        {{$producto->cantidad_inventario}} unidades disponibles
                                                                    </p>
                                                                </div>
                                                                <img src="{{ asset('images/productos.jpg') }}"
                                                        ...
                                                        <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                            <div class="why-text full-width">
                                                                ...
                                                                <p>Integer tincidunt aliquet nibh vitae dictum. In turpis
                                                                    ...
                                                                    amet
                                                                    orci porta, eget aliquam purus
                                                                    sollicitudin. Cras eu metus felis. Sed arcu arcu,
                                                                    sagittis
                                                                    in blandit eu, imperdiet sit amet eros. Donec accumsan
                                                                    nisi
                                                                    purus, quis euismod ex volutpat in. Vestibulum eleifend
                                                                    eros
                                                                    ac lobortis aliquet.
                                    ...
                                    <div class="list-group list-group-collapse list-group-sm list-group-tree"
                                        ...
                                        <div class="list-group-collapse sub-men">
                                            <a class="list-group-item list-group-item-action" href="#sub-men2"
                                                ...
                                                aria-controls="sub-men2">Vegetables
